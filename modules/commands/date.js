...
"Một mất mười ngờ",
"Cóc có gan cóc, kiến có gan kiến.", "Máu trâu cũng như máu bò", "Lòng vả cũng như lòng sung", "Ba thưng cũng vào một đấu", "Suy bụng ta ra bụng người", "Bói ra ma, quét nhà ra rác", "Giang sơn đâu, anh hùng đấy", "Cơm đâu no chó, thóc đâu no gà",
"Quá mù ra mưa.",
"Chín quá hóa nẫu",
"Trèo cao ngã đau",
"Thắm lắm phai nhiều",
...
api.sendMessage("Bây giờ là: "+time+`\n${day},  `+date+ `\nCanh Ngôn: ${dat[Math.floor(Math.random() * dat.length)]}\n\nChúc bạn một ngày tốt lành!!!`,event.threadID,event.messageID)
}